...
            pageInfo.pageIndex = pageIndex ?? 1;
            ...
            if (keywords != null && keywords != "")
            {
                ...
                IEnumerable<tb_LogInfo> iEn = pageInfo.pageList.Where(p => p.Time.Contains(keywords) || p.Operation.Contains(keywords) || p.UserName.Contains(keywords) || p.Operation.Contains(keywords) || p.FileName.Contains(keywords));
                int index = 1; 
